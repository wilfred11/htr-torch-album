...
import torch
from files.model import CRNN, BBox, visualize_model, visualize_featuremap, visualize_featuremap1
...
if do == 1:
    with keep.running() as k:
        ...
        trl, tl = dataset_load(image_transform, char_to_int_map, 10000, text_label_max_length, char_set)
        ...
        #visualize_featuremap1(crnn, trl)
